...
export const STRIPE_PRICE_IDS: Record<LookupKey, string> = {
  ...
  mpm_premium_monthly: process.env.STRIPE_PRICE_PREMIUM || "price_1SGlZUJC1cXhpBKwvCSYVTv3",
  mpm_premium_beta_monthly: process.env.STRIPE_PRICE_BETA || "price_1SGlgNJC1cXhpBKwZFm8rFBV",
