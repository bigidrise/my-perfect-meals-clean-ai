...
// Optional override for rare cases where API is on a different host
...
/**
 * In dev:  http://<your local host>:5000  (via Vite proxy or direct)
 * In prod: SAME ORIGIN (relative) e.g. https://yourapp.com
