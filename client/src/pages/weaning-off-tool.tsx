    ...
    <div className="min-h-screen bg-gradient-to-br from-black/60 via-orange-600 to-black/80 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <Button
          ...
          className="fixed top-4 left-4 bg-black/10 backdrop-blur-none border border-white/20 rounded-2xl hover:bg-black/30 text-white z-50"
          data-testid="button-back-to-hub"
        >
          <ArrowLeft className="mr-2 h-4 w-4" />
          {step === "tracking" ? "Back to Setup" : "Alcohol Hub"}
        </Button>
