      ...
      >
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <Button
            ...
            className="bg-black/10 hover:bg-black/50 text-white rounded-xl text-md font-medium border border-white/10 backdrop-blur-none flex items-center px-3 h-10 gap-1"
          >
