  ...
  return (
    <PhaseGate phase="PHASE_1_CORE" feature="craving-creator">
      ...
      <button
        ...
        className="fixed top-2 left-2 sm:top-4 sm:left-4 z-50 p-1 bg-black/10 backdrop-blur-md border border-white/20 rounded-lg text-white hover:bg-black/30 transition-all"
                  ...
                  <div className="w-full" aria-live="polite">
                    <div className="flex items-center justify-center gap-2 text-orange-600 mb-4">
                      ...
                      <span className="text-lg font-medium">
                        Crafting your personalized craving...
                      </span>
                    </div>

                    {/* 🔋 Animated Progress Bar (Restaurant Guide Style) */}
                    <div className="max-w-md mx-auto">
                      {/* Fill: inline gradient (can’t be purged), width follows progress */}
                      <div
                        className="h-2 rounded-full transition-[width] duration-200 ease-linear"
                        style={{
                          width: `${progress}%`,
                          background:
