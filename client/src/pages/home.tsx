        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-background/70">
                <li><Button variant="link" className="text-background/70 hover:text-background p-0 h-auto">Help Center</Button></li>
                <li><Button variant="link" className="text-background/70 hover:text-background p-0 h-auto">Contact Us</Button></li>
                <li><Button variant="link" className="text-background/70 hover:text-background p-0 h-auto">Privacy Policy</Button></li>
                <li><Button variant="link" className="text-background/70 hover:text-background p-0 h-auto">Terms of Service</Button></li>
              </ul>
            </div>
          </div>
