    ...
    try {
      ...
      for (const meal of allMeals) {
        const logEntry = {
          ...
          source: "clinical-meal-board-bulk"
        };
        ...
        <div className="max-w-2xl mx-auto p-4 md:p-8">
          <div className="bg-black/30 backdrop-blur-lg border border-white/20 rounded-2xl p-8 text-center shadow-2xl mb-8">
            <h1 className="text-2xl md:text-3xl font-semibold text-white mb-4">
              🏥 Clinical Lifestyle Meal Board
            </h1>
            <p className="text-sm text-white/90 max-w-xl mx-auto">
              Build your meal plan with clinical diet protocols
            </p>
          </div>
          ...
          <div className="bg-black/30 backdrop-blur-lg border border-white/20 rounded-2xl p-6 mb-8">
            ...
            <Select value={selectedDiet} onValueChange={setSelectedDiet}>
              ...
              <SelectContent>
                ...
                <SelectItem value="aip">Autoimmune Protocol (AIP)</SelectItem>
                <SelectItem value="cardiac">Heart-Healthy (Cardiac)</SelectItem>
                <SelectItem value="renal">Kidney/Renal Friendly</SelectItem>
                <SelectItem value="bariatric">Bariatric Protocol</SelectItem>
                <SelectItem value="anti_inflammatory">Anti-Inflammatory</SelectItem>
                <SelectItem value="liver_friendly">Liver-Friendly</SelectItem>
              </SelectContent>
            </Select>
          </div>

          <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-8 text-center">
            <p className="text-xl font-semibold text-white mb-2">⚠️ Choose a clinical diet to continue</p>
            <p className="text-sm text-white/70">
              Select a clinical diet from the dropdown above to start building your meal plan
            </p>
          </div>
        </div>
      </motion.div>
              ...
              <div className="flex items-center gap-2">
                <Select value={selectedDiet} onValueChange={setSelectedDiet}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="cardiac">Heart-Healthy</SelectItem>
                    <SelectItem value="renal">Renal Friendly</SelectItem>
      ...
      {board && (() => {
                  ...
                  <div className="flex gap-2">
                    <Button
                      onClick={() => {
                        ...
                        setTimeout(() => setLocation('/shopping-list-v2?from=clinical-meal-board'), 100);
                      }}
        ...
        return (
          <ShoppingAggregateBar
            ...
            source={`Clinical Meal Plan (${formatWeekLabel(weekStartISO)})`}
            sourceSlug="clinical-meal-board"
          />
        );
      })()}
    </motion.div>
