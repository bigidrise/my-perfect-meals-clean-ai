...
type ClinicalDietMode = "low_fodmap" | "aip" | "cardiac" | "renal" | "bariatric" | "anti_inflammatory" | "liver_friendly";
...
export default function ClinicalLifestyleDietMenuBuilder() {
  ...
  const [clinicalDietMode, setClinicalDietMode] = React.useState<ClinicalDietMode>("low_fodmap");

  // TODO PHASE 4: Wire this to actual picker ingredients
  const activeClinicalPickerConfig = clinicalDietPickerConfig[clinicalDietMode];
            ...
            <div className="relative z-10">
              ...
              <Select value={clinicalDietMode} onValueChange={(val) => {
                ...
                <SelectContent>
                  ...
                  <SelectItem value="aip">Autoimmune Protocol</SelectItem>
              ...
              <p className="text-xs text-white/60 mt-2">Selected: {clinicalDietMode}</p>
            </div>
          </div>
