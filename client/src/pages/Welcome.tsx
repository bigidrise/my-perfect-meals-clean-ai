...
const slides = [
  {
    ...
    title: "Stay on Track",
    subtitle:
      "Effortless tracking that keeps your meals balanced.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    subtitle:
      "Let your nutrition coach  Choiceconcierge order for you.",
  },
  {
    id: 4,
    ...
    subtitle:
      "Enjoy your desserts and favorites without the guilt.",
  },
  {
    id: 5,
    ...
    subtitle:
      "Smart, balanced meals designed to fuel happy, healthy kids.",
  },
] as const;
    ...
    return (
      <div className="relative min-h-screen bg-black text-white flex flex-col items-center justify-center px-6">
        ...
        <div className="mb-12 flex justify-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-black via-orange-600 to-black rounded-full border border-orange-400/30 shadow-lg">
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-neutral-700 via-black to-black text-white flex flex-col items-center overflow-x-hidden">
      <header className="w-full max-w-xl text-center pt-8 px-4">
        ...
        <p className="text-sm text-neutral-400 mt-2">
          The <span className="font-semibold">First-Generation Smart Nutrition App</span> you can depend on.
        </p>
