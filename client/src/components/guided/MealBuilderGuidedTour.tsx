      ...
      {pickerOpen && (
        <>
          <button
            ...
            className="fixed top-4 right-4 z-[80] bg-lime-700 hover:bg-lime-800 border-2 border-lime-600 text-white rounded-full w-12 h-12 flex items-center justify-center font-semibold text-xl backdrop-blur-sm flash-border"
            title="How it works"
          >
            ?
          </button>
