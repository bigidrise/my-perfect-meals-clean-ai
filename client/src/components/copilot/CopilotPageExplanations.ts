...
export const PAGE_EXPLANATIONS: Record<string, PageExplanation> = {
  "/my-biometrics": {
    ...
    spokenText:
      "My Biometrics, log and keep your daily macros using our barcode photo scan logger, send over macros from your generated meal cards. Keep track of your calories from daily up to 30 days. Keep track of your weight daily up to a year. Track your daily water intake with our water log tracker",
    autoClose: true,
  },
