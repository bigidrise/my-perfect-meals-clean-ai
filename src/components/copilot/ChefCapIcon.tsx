...
export const ChefCapIcon: React.FC<ChefCapIconProps> = ({
  ...
  return (
    <motion.div
      className="relative flex items-center justify-center rounded-full bg-black/70 border border-white/10 backdrop-blur-md"
    ...
    >
      ...
      >
        ...
        <path
          ...
          fill="url(#chefCapGradient)"
        />
        <path d="M18 32h28v5H18z" fill="rgba(15,23,42,0.95)" />
        <path
      ...
      {/* tiny highlight */}
      <div className="absolute -top-0.5 -left-0.5 w-2 h-2 rounded-full bg-white/70 opacity-70" />
    </motion.div>
  );
};
